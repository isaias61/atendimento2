...
<?php
				...
				//	echo 'Hora é ' . $hora . '<br>';
					...
					mysqli_query($conn, "INSERT INTO atende (data, codidata, nome, hora, sta ,atd) VALUES ('$demi','$codidata','PEGA DOCUMENTO' , '$hora','Aberto','PEG')");
...
<div> 
 ...
 echo "\n <br />";
		  ...
		  $mostrar = "PEGAR DOC. - CUPOM PEG-" . $id;
          ...
          <div class="col-sm-6"> 
			  ...
			  <div class="col-sm-6"> 
				  ...
				  <p class="jumbotron text-center"><strong><? echo $mostrar; ?></strong>
					<button href="" id="botaoPrint" name="botaoPrint" type="submit" class="btn btn-warning btn-block btn-lg">
